...
alias myip='curl ifconfig.co' # Print public IP
...
alias tk='tmux list-sessions | grep -v attached | cut -d: -f1 | xargs -I {} tmux kill-session -t {}'
alias vim='tmux new-session -A -s nvim nvim'
